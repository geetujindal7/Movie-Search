...
import { onAirAction, topRatedSeriesAction } from "@/Redux/actions";
  
  function TopRatedSeries() {
    const filter = useSelector((state) => state.topRatedSeries.state);
          ...
          <>
            ...
            >
              <Box sx={{ display: "flex", gap: "5px", padding: "15px" }}>
                ...
                <Typography sx={{ marginTop: "2px", fontSize: "20px" }}>Top Rated Series</Typography>
